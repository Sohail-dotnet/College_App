...
namespace WebApplication1.Controllers
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        public StudentController(ILogger<StudentController> logger, CollegeDBContext dBContext, IMapper mapper, StudentRepository studentRepository)
        {
            _logger = logger;
            _mapper = mapper;
        ...
        {
            var student = await _studentRepository.GetAsync(student=> student.Name.ToLower().Contains(name.ToLower())); // Deligate or anonymous Method passing to GetByNameAsync
        ...
        public async Task<ActionResult<bool>> DeleteStudentDataByIdAsync(int id)
        {
            ...
            var student = await _studentRepository.GetAsync(student => student.Id == id, true);
